...
export class PORTFOLIOComponent {
  ...
  constructor() {
    this.projects = [
      ...
      { id: 12, visiable: true, linkgithub: "https://github.com/fatmaelshemy/gameProject", title: "Game Project", catId: 3, image: "assets/images/gameapp.PNG", description: "CRUD operation MVC project to add , update , read and delete game  apply client side and server sise validation, Custom Validation in Cover Image To validate Max size and extension , use alot of client side library." },
      { id: 13, visiable: true, linkgithub: "https://github.com/fatmaelshemy/store-manegment-system", title: "Store Management System", catId: 6, image: "assets/images/img9.PNG", description: "My introductory project in C programming, focusing on category and product management, including functionalities for updating, deleting, and purchasing products. It generates invoices with detailed order information." },
    ];
  }
  options: any = [
